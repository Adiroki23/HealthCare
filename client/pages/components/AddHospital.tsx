...
function AddHospital() {
  ...
  const styles = {
    ...
    txt_container: `w-9/12 h-1/6 flex flex-col justify-end`,
    ...
    main_box: `bg-high_contrast_yellow w-full h-full drop-shadow-3xl border-4 flex flex-col justify-around p-10`,
    ...
    connect_wallet: `bg-dark_pink border-2 drop-shadow-2xl w-5/12 h-full flex flex-col justify-center items-center active:mt-2 active:drop-shadow-xl active:bg-grinish-yellow`,
